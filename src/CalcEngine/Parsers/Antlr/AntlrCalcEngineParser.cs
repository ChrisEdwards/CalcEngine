...
{
	public class AntlrCalcEngineParser : Parser
	{
		...
		public root_return root() // throws RecognitionException [1]
		{
			var retval = new root_return();
			retval.Start = input.LT( 1 );

			CommonTree root_0 = null;

			rootLevelStatement_return rootLevelStatement1 = default( rootLevelStatement_return );
		...
		public exclusivePropertyModifier_return exclusivePropertyModifier() // throws RecognitionException [1]
		{
			var retval = new exclusivePropertyModifier_return();
			retval.Start = input.LT( 1 );
		...
		public propertyModifier_return propertyModifier() // throws RecognitionException [1]
		{
			var retval = new propertyModifier_return();
			retval.Start = input.LT( 1 );
		...
		public orExpr_return orExpr() // throws RecognitionException [1]
		{
			var retval = new orExpr_return();
			retval.Start = input.LT( 1 );

			CommonTree root_0 = null;

			andExpr_return andExpr38 = default( andExpr_return );

			orOp_return orOp39 = default( orOp_return );

			andExpr_return andExpr40 = default( andExpr_return );
		...
		public andExpr_return andExpr() // throws RecognitionException [1]
		{
			var retval = new andExpr_return();
			retval.Start = input.LT( 1 );

			CommonTree root_0 = null;

			equalityExpr_return equalityExpr41 = default( equalityExpr_return );

			andOp_return andOp42 = default( andOp_return );

			equalityExpr_return equalityExpr43 = default( equalityExpr_return );
		...
		public unaryExpr_return unaryExpr() // throws RecognitionException [1]
		{
			var retval = new unaryExpr_return();
			retval.Start = input.LT( 1 );

			CommonTree root_0 = null;

			unaryNegationOp_return unaryNegationOp63 = default( unaryNegationOp_return );

			negationExpr_return negationExpr64 = default( negationExpr_return );
		...
		public negationExpr_return negationExpr() // throws RecognitionException [1]
		{
			var retval = new negationExpr_return();
			retval.Start = input.LT( 1 );

			CommonTree root_0 = null;

			notOp_return notOp65 = default( notOp_return );

			primaryExpr_return primaryExpr66 = default( primaryExpr_return );
		...
		public notOp_return notOp() // throws RecognitionException [1]
		{
			var retval = new notOp_return();
			retval.Start = input.LT( 1 );
			...
			var stream_72 = new RewriteRuleTokenStream( adaptor, "token 72" );
				...
				switch ( alt22 )
				{
					case 1:
						// C:\\Projects\\CalcEngine\\src\\CalcEngine\\Parsers\\Antlr\\AntlrCalcEngine.g:174:4: x= 'not'
						{
							...
							// 174:12: -> OP_NOT[$x]
							{
								adaptor.AddChild( root_0, adaptor.Create( OP_NOT, x ) );
							}
		...
		public ltOp_return ltOp() // throws RecognitionException [1]
		{
			var retval = new ltOp_return();
			retval.Start = input.LT( 1 );
			...
			try
			{
				...
				// C:\\Projects\\CalcEngine\\src\\CalcEngine\\Parsers\\Antlr\\AntlrCalcEngine.g:198:4: x= '<'
				{
					...
					// 198:10: -> OP_LT[$x]
					{
						adaptor.AddChild( root_0, adaptor.Create( OP_LT, x ) );
					}
		...
		public gtOp_return gtOp() // throws RecognitionException [1]
		{
			var retval = new gtOp_return();
			retval.Start = input.LT( 1 );
			...
			try
			{
				...
				// C:\\Projects\\CalcEngine\\src\\CalcEngine\\Parsers\\Antlr\\AntlrCalcEngine.g:201:4: x= '>'
				{
					...
					// 201:10: -> OP_GT[$x]
					{
						adaptor.AddChild( root_0, adaptor.Create( OP_GT, x ) );
					}
		...
		public lteOp_return lteOp() // throws RecognitionException [1]
		{
			var retval = new lteOp_return();
			retval.Start = input.LT( 1 );
			...
			try
			{
				...
				// C:\\Projects\\CalcEngine\\src\\CalcEngine\\Parsers\\Antlr\\AntlrCalcEngine.g:204:4: x= '<='
				{
					...
					// 204:11: -> OP_LTE[$x]
					{
						adaptor.AddChild( root_0, adaptor.Create( OP_LTE, x ) );
					}
		...
		public gteOp_return gteOp() // throws RecognitionException [1]
		{
			var retval = new gteOp_return();
			retval.Start = input.LT( 1 );
			...
			try
			{
				...
				// C:\\Projects\\CalcEngine\\src\\CalcEngine\\Parsers\\Antlr\\AntlrCalcEngine.g:207:4: x= '>='
				{
					...
					// 207:11: -> OP_GTE[$x]
					{
						adaptor.AddChild( root_0, adaptor.Create( OP_GTE, x ) );
					}
		...
		public addOp_return addOp() // throws RecognitionException [1]
		{
			var retval = new addOp_return();
			retval.Start = input.LT( 1 );
			...
			try
			{
				...
				// C:\\Projects\\CalcEngine\\src\\CalcEngine\\Parsers\\Antlr\\AntlrCalcEngine.g:210:4: x= '+'
				{
					...
					// 210:10: -> OP_ADD[$x]
					{
						adaptor.AddChild( root_0, adaptor.Create( OP_ADD, x ) );
					}
		...
		public subtractOp_return subtractOp() // throws RecognitionException [1]
		{
			var retval = new subtractOp_return();
			retval.Start = input.LT( 1 );
			...
			CommonTree x_tree = null;
			var stream_87 = new RewriteRuleTokenStream( adaptor, "token 87" );
			...
			try
			{
				...
				// C:\\Projects\\CalcEngine\\src\\CalcEngine\\Parsers\\Antlr\\AntlrCalcEngine.g:213:4: x= '-'
				{
					...
					{
						adaptor.AddChild( root_0, adaptor.Create( OP_SUBTRACT, x ) );
					}
		...
		public multiplyOp_return multiplyOp() // throws RecognitionException [1]
		{
			var retval = new multiplyOp_return();
			retval.Start = input.LT( 1 );
			...
			CommonTree x_tree = null;
			var stream_88 = new RewriteRuleTokenStream( adaptor, "token 88" );
			...
			try
			{
				...
				// C:\\Projects\\CalcEngine\\src\\CalcEngine\\Parsers\\Antlr\\AntlrCalcEngine.g:216:4: x= '*'
				{
					...
					{
						adaptor.AddChild( root_0, adaptor.Create( OP_MULTIPLY, x ) );
					}
		...
		public divideOp_return divideOp() // throws RecognitionException [1]
		{
			var retval = new divideOp_return();
			retval.Start = input.LT( 1 );
			...
			CommonTree x_tree = null;
			var stream_89 = new RewriteRuleTokenStream( adaptor, "token 89" );
			...
			try
			{
				...
				// C:\\Projects\\CalcEngine\\src\\CalcEngine\\Parsers\\Antlr\\AntlrCalcEngine.g:219:4: x= '/'
				{
					...
					// 219:10: -> OP_DIVIDE[$x]
					{
						adaptor.AddChild( root_0, adaptor.Create( OP_DIVIDE, x ) );
					}
		...
		public unaryNegationOp_return unaryNegationOp() // throws RecognitionException [1]
		{
			var retval = new unaryNegationOp_return();
			retval.Start = input.LT( 1 );
			...
			try
			{
				...
				// C:\\Projects\\CalcEngine\\src\\CalcEngine\\Parsers\\Antlr\\AntlrCalcEngine.g:222:4: x= '-'
				{
					...
					{
						adaptor.AddChild( root_0, adaptor.Create( OP_UNARY_NEGATION, x ) );
					}
		...
		public entityChainNoFilter_return entityChainNoFilter() // throws RecognitionException [1]
		{
			var retval = new entityChainNoFilter_return();
			retval.Start = input.LT( 1 );

			CommonTree root_0 = null;

			IToken char_literal80 = null;
			entity_return entity79 = default( entity_return );

			entity_return entity81 = default( entity_return );
		...
		public filteredEntity_return filteredEntity() // throws RecognitionException [1]
		{
			var retval = new filteredEntity_return();
			retval.Start = input.LT( 1 );

			CommonTree root_0 = null;

			entity_return entity82 = default( entity_return );

			criteria_return criteria83 = default( criteria_return );
		...
		public thisKeyword_return thisKeyword() // throws RecognitionException [1]
		{
			var retval = new thisKeyword_return();
			retval.Start = input.LT( 1 );
			...
			CommonTree x_tree = null;
			var stream_91 = new RewriteRuleTokenStream( adaptor, "token 91" );
			...
			try
			{
				...
				// C:\\Projects\\CalcEngine\\src\\CalcEngine\\Parsers\\Antlr\\AntlrCalcEngine.g:242:4: x= 'this'
				{
					...
					// 242:13: -> THIS[$x]
					{
						adaptor.AddChild( root_0, adaptor.Create( THIS, x ) );
					}
		...
		public entity_return entity() // throws RecognitionException [1]
		{
			var retval = new entity_return();
			retval.Start = input.LT( 1 );
			...
			try
			{
				...
				// C:\\Projects\\CalcEngine\\src\\CalcEngine\\Parsers\\Antlr\\AntlrCalcEngine.g:246:4: x= ID
				{
					...
					// 246:9: -> ENTITY[$x]
					{
						adaptor.AddChild( root_0, adaptor.Create( ENTITY, x ) );
					}
		...
		public static readonly BitSet FOLLOW_rootLevelStatement_in_root231 = new BitSet( new[] {0x0200040000000002UL} );
		public static readonly BitSet FOLLOW_formulaDeclaration_in_rootLevelStatement242 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_classDeclaration_in_rootLevelStatement248 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_57_in_classDeclaration262 = new BitSet( new[] {0x0000040000000000UL} );
		public static readonly BitSet FOLLOW_name_in_classDeclaration264 = new BitSet( new[] {0x1400000000000000UL} );
		public static readonly BitSet FOLLOW_baseClassDeclaration_in_classDeclaration266 = new BitSet( new[] {0x1400000000000000UL} );
		public static readonly BitSet FOLLOW_classStatementBlock_in_classDeclaration269 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_58_in_baseClassDeclaration294 = new BitSet( new[] {0x0000040000000000UL} );
		public static readonly BitSet FOLLOW_name_in_baseClassDeclaration296 = new BitSet( new[] {0x0800000000000000UL} );
		public static readonly BitSet FOLLOW_59_in_baseClassDeclaration298 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_expression_in_baseClassDeclaration300 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_60_in_classStatementBlock328 = new BitSet( new[] {0x6000000000000000UL, 0x0000000000000008UL} );
		public static readonly BitSet FOLLOW_classLevelStatement_in_classStatementBlock330 = new BitSet( new[] {0x6000000000000000UL, 0x0000000000000008UL} );
		public static readonly BitSet FOLLOW_61_in_classStatementBlock333 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_propertyDeclaration_in_classLevelStatement354 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_relationshipDeclaration_in_classLevelStatement359 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_ID_in_name371 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_62_in_propertyDeclaration389 = new BitSet( new[] {0x0000040000000000UL} );
		public static readonly BitSet FOLLOW_name_in_propertyDeclaration391 = new BitSet( new[] {0x8000000000000000UL, 0x0000000000000007UL} );
		public static readonly BitSet FOLLOW_propertyModifiers_in_propertyDeclaration393 = new BitSet( new[] {0x8000000000000000UL} );
		public static readonly BitSet FOLLOW_63_in_propertyDeclaration396 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_exclusivePropertyModifier_in_propertyModifiers419 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_propertyModifier_in_propertyModifiers434 = new BitSet( new[] {0x0000000000000002UL, 0x0000000000000007UL} );
		public static readonly BitSet FOLLOW_64_in_exclusivePropertyModifier456 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_set_in_propertyModifier0 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_67_in_relationshipDeclaration484 = new BitSet( new[] {0x0000040000000000UL} );
		public static readonly BitSet FOLLOW_name_in_relationshipDeclaration486 = new BitSet( new[] {0x0000000000000000UL, 0x0000000000000010UL} );
		public static readonly BitSet FOLLOW_68_in_relationshipDeclaration488 = new BitSet( new[] {0x0000040000000000UL} );
		public static readonly BitSet FOLLOW_relationshipJoinDeclaration_in_relationshipDeclaration490 = new BitSet( new[] {0x8000000000000000UL} );
		public static readonly BitSet FOLLOW_63_in_relationshipDeclaration492 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_name_in_relationshipJoinDeclaration514 = new BitSet( new[] {0x0800000000000000UL} );
		public static readonly BitSet FOLLOW_59_in_relationshipJoinDeclaration516 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_expression_in_relationshipJoinDeclaration518 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_entityChainNoFilter_in_formulaDeclaration558 = new BitSet( new[] {0x0000000000000000UL, 0x0000000000000010UL} );
		public static readonly BitSet FOLLOW_assignmentOp_in_formulaDeclaration560 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_expression_in_formulaDeclaration562 = new BitSet( new[] {0x8000000000000000UL} );
		public static readonly BitSet FOLLOW_63_in_formulaDeclaration564 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_orExpr_in_expression599 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_andExpr_in_orExpr609 = new BitSet( new[] {0x0000000000000002UL, 0x0000000000000600UL} );
		public static readonly BitSet FOLLOW_orOp_in_orExpr613 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_andExpr_in_orExpr616 = new BitSet( new[] {0x0000000000000002UL, 0x0000000000000600UL} );
		public static readonly BitSet FOLLOW_equalityExpr_in_andExpr629 = new BitSet( new[] {0x0000000000000002UL, 0x0000000000001800UL} );
		public static readonly BitSet FOLLOW_andOp_in_andExpr633 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_equalityExpr_in_andExpr636 = new BitSet( new[] {0x0000000000000002UL, 0x0000000000001800UL} );
		public static readonly BitSet FOLLOW_relationalExpr_in_equalityExpr650 = new BitSet( new[] {0x0000000000000002UL, 0x0000000000038010UL} );
		public static readonly BitSet FOLLOW_equalsOp_in_equalityExpr656 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_notEqualsOp_in_equalityExpr661 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_relationalExpr_in_equalityExpr666 = new BitSet( new[] {0x0000000000000002UL, 0x0000000000038010UL} );
		public static readonly BitSet FOLLOW_additiveExpr_in_relationalExpr679 = new BitSet( new[] {0x0000000000000002UL, 0x00000000003C0000UL} );
		public static readonly BitSet FOLLOW_ltOp_in_relationalExpr685 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_gtOp_in_relationalExpr690 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_lteOp_in_relationalExpr695 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_gteOp_in_relationalExpr700 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_additiveExpr_in_relationalExpr705 = new BitSet( new[] {0x0000000000000002UL, 0x00000000003C0000UL} );
		public static readonly BitSet FOLLOW_multiplicativeExpr_in_additiveExpr719 = new BitSet( new[] {0x0000000000000002UL, 0x0000000000C00000UL} );
		public static readonly BitSet FOLLOW_addOp_in_additiveExpr725 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_subtractOp_in_additiveExpr730 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_multiplicativeExpr_in_additiveExpr735 = new BitSet( new[] {0x0000000000000002UL, 0x0000000000C00000UL} );
		public static readonly BitSet FOLLOW_unaryExpr_in_multiplicativeExpr749 = new BitSet( new[] {0x0000000000000002UL, 0x0000000003006000UL} );
		public static readonly BitSet FOLLOW_multiplyOp_in_multiplicativeExpr755 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_divideOp_in_multiplicativeExpr760 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_modulusOp_in_multiplicativeExpr765 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_unaryExpr_in_multiplicativeExpr770 = new BitSet( new[] {0x0000000000000002UL, 0x0000000003006000UL} );
		public static readonly BitSet FOLLOW_unaryNegationOp_in_unaryExpr785 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_negationExpr_in_unaryExpr789 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_notOp_in_negationExpr802 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_primaryExpr_in_negationExpr808 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_69_in_primaryExpr819 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_expression_in_primaryExpr822 = new BitSet( new[] {0x0000000000000000UL, 0x0000000000000040UL} );
		public static readonly BitSet FOLLOW_70_in_primaryExpr824 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_number_in_primaryExpr830 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_booleanValue_in_primaryExpr835 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_LITERAL_in_primaryExpr840 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_functionCall_in_primaryExpr845 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_entityChain_in_primaryExpr850 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_71_in_notOp868 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_72_in_notOp880 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_73_in_orOp898 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_74_in_orOp910 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_75_in_andOp927 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_76_in_andOp939 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_77_in_modulusOp957 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_78_in_modulusOp969 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_79_in_equalsOp988 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_68_in_equalsOp1001 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_80_in_notEqualsOp1019 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_81_in_notEqualsOp1031 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_82_in_ltOp1048 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_83_in_gtOp1065 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_84_in_lteOp1082 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_85_in_gteOp1099 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_86_in_addOp1116 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_87_in_subtractOp1133 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_88_in_multiplyOp1150 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_89_in_divideOp1167 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_87_in_unaryNegationOp1184 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_68_in_assignmentOp1201 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_thisKeyword_in_entityChain1224 = new BitSet( new[] {0x0000000000000002UL, 0x0000000004000000UL} );
		public static readonly BitSet FOLLOW_filteredEntity_in_entityChain1228 = new BitSet( new[] {0x0000000000000002UL, 0x0000000004000000UL} );
		public static readonly BitSet FOLLOW_90_in_entityChain1234 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_filteredEntity_in_entityChain1237 = new BitSet( new[] {0x0000000000000002UL, 0x0000000004000000UL} );
		public static readonly BitSet FOLLOW_entity_in_entityChainNoFilter1250 = new BitSet( new[] {0x0000000000000002UL, 0x0000000004000000UL} );
		public static readonly BitSet FOLLOW_90_in_entityChainNoFilter1254 = new BitSet( new[] {0x0000040000000000UL} );
		public static readonly BitSet FOLLOW_entity_in_entityChainNoFilter1257 = new BitSet( new[] {0x0000000000000002UL, 0x0000000004000000UL} );
		public static readonly BitSet FOLLOW_entity_in_filteredEntity1271 = new BitSet( new[] {0x0000000000000002UL, 0x0000000010000000UL} );
		public static readonly BitSet FOLLOW_criteria_in_filteredEntity1274 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_91_in_thisKeyword1287 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_ID_in_entity1305 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_92_in_criteria1320 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_expression_in_criteria1322 = new BitSet( new[] {0x0000000000000000UL, 0x0000000020000000UL} );
		public static readonly BitSet FOLLOW_93_in_criteria1324 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_ID_in_functionCall1352 = new BitSet( new[] {0x0000000000000000UL, 0x0000000000000020UL} );
		public static readonly BitSet FOLLOW_69_in_functionCall1354 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001E0UL} );
		public static readonly BitSet FOLLOW_expression_in_functionCall1358 = new BitSet( new[] {0x0000000000000000UL, 0x0000000040000040UL} );
		public static readonly BitSet FOLLOW_94_in_functionCall1362 = new BitSet( new[] {0x00003C0000000000UL, 0x00000001888001A0UL} );
		public static readonly BitSet FOLLOW_expression_in_functionCall1364 = new BitSet( new[] {0x0000000000000000UL, 0x0000000040000040UL} );
		public static readonly BitSet FOLLOW_70_in_functionCall1372 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_ID_in_identifier1399 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_set_in_number0 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_95_in_booleanValue1440 = new BitSet( new[] {0x0000000000000002UL} );
		public static readonly BitSet FOLLOW_96_in_booleanValue1452 = new BitSet( new[] {0x0000000000000002UL} );
	}
}